...
export async function getDb() {
  if (!_db) {
    ...
    try {
      ...
      if (error && typeof error === "object" && "message" in error && typeof error.message === "string" && error.message.includes("timeout") && connStr.includes("supabase.com") && !connStr.includes("6543")) {
